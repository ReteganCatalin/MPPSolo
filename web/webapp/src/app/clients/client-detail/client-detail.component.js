...
var MovieDetailComponent = (function () {
    function MovieDetailComponent(clientService, route, location) {
    ...
    MovieDetailComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.params
            .switchMap(function (params) { return _this.clientService.getMovie(+params['id']); })
    ...
    __decorate([
        core_1.Input()
    ], MovieDetailComponent.prototype, "client", void 0);
